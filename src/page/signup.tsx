...
import { registerAsync } from "../app/slice/authSlice";
...
const SignUp: React.FC = () => {
  ...
  const createAccount = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    dispatch(registerAsync({ email: email, password: password }));
    navigate("/"); // Navigate to home page or dashboard after sign up
  };
